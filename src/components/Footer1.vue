            ...
            <div class="relative z-10 justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
                <div class="flex flex-wrap pb-10 -mx-3">
                    <div class="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
                        <a href="#" class="inline-block pb-2 text-lg font-bold text-gray-300">O firme</a>
                    ...
                    <div class="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                        <h2 class="pb-2 text-lg font-bold text-gray-300 ">Linky</h2>
                        <div class="w-16 mb-4 border-b-2 border-gray-300 "></div>
                        <ul>
                            <li class="mb-4">
                                <RouterLink to="/" class="inline-block text-base font-normal text-gray-400 ">Home</RouterLink>
                            </li>
                            <li class="mb-4">
                                <RouterLink to="/about" class="inline-block text-base font-normal text-gray-400 ">
                                  O nás</RouterLink>
                            </li>
                            <li class="mb-4">
                                <RouterLink to="/cart"
                                    class="inline-block text-base font-normal text-gray-400 dark:text-gray-400">kosik</RouterLink>
                            </li>
                        </ul>
                    </div>
